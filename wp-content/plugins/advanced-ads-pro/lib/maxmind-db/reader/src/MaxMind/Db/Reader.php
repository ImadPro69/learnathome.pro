...
namespace AdvancedAdsPro\MaxMind\Db;

use BadMethodCallException;
use Exception;
use InvalidArgumentException;
use AdvancedAdsPro\MaxMind\Db\Reader\Decoder;
use AdvancedAdsPro\MaxMind\Db\Reader\InvalidDatabaseException;
use AdvancedAdsPro\MaxMind\Db\Reader\Metadata;
use AdvancedAdsPro\MaxMind\Db\Reader\Util;
...
class Reader
{
     ...
     * @throws \AdvancedAdsPro\MaxMind\Db\Reader\InvalidDatabaseException
