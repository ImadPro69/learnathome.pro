...
class Grimlock_Login {
	...
	public function __construct() {
		...
		add_action( 'grimlock_hamburger_navbar_nav_menu', array( $this, 'add_navbar_nav_menu'  ), 110, 1 );
	...
	public function add_lost_password_register_link( $content, $args ) {
		// Don't add Register and Lost password links for PMPro login form because they add their own
		if ( has_action( 'login_form_top', 'pmpro_login_form_hidden_field' ) ) {
			return $content;
		}
