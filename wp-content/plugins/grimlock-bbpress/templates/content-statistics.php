					...
					<div class="bg-black-faded rounded-card p-2 w-100 h-100">
						<div class="row align-items-center">
							...
							<div class="col">
								...
								<h5 class="text-muted text-uppercase small font-weight-bold mb-0 mt-2"><?php esc_html_e( 'Registered Users', 'bbpress' ); ?></h5>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="bg-black-faded rounded-card p-2 w-100 h-100">
						<div class="row align-items-center">
							...
							<div class="col">
								...
								<h5 class="text-muted text-uppercase small font-weight-bold mb-0 mt-2"><?php esc_html_e( 'Forums', 'bbpress' ); ?></h5>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="bg-black-faded rounded-card p-2 w-100 h-100">
						<div class="row align-items-center">
							...
							<div class="col">
								...
								<h5 class="text-muted text-uppercase small font-weight-bold mb-0 mt-2"><?php esc_html_e( 'Topics', 'bbpress' ); ?></h5>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="bg-black-faded rounded-card p-2 w-100 h-100">
						<div class="row align-items-center">
							...
							<div class="col">
								...
								<h5 class="text-muted text-uppercase small font-weight-bold mb-0 mt-2"><?php esc_html_e( 'Replies', 'bbpress' ); ?></h5>
							</div>
						</div>
					</div>
				</div>
