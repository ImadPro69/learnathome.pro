...
/**
 * Class Grimlock_Term_Query_Block
 *
 * @author  themosaurus
 * @since   1.1.0
 * @package grimlock/inc
 */
class Grimlock_Term_Query_Block extends Grimlock_Base_Block {
	 ...
	 * @since 1.3.8
	 */
	public function __construct( $type = 'term-query', $domain = 'grimlock' ) {
		...
		// Layout tab
		add_filter( "{$this->id_base}_layout_panel_fields",     array( $this, 'add_terms_layout_field'          ), 100 );
...
//			),
	...
	public function add_terms_layout_field( $fields ) {
		$fields[] = $this->radio_image_field( apply_filters( "{$this->id_base}_terms_layout_field_args", array(
			...
			'choices' => array(
				...
				'4-4-4-cols-circle'           => GRIMLOCK_PLUGIN_DIR_URL . 'assets/images/posts-4-4-4-cols-circle.png',
				'3-3-3-3-cols-circle'         => GRIMLOCK_PLUGIN_DIR_URL . 'assets/images/posts-3-3-3-3-cols-circle.png',
				'2-2-2-2-2-2-cols-circle'     => GRIMLOCK_PLUGIN_DIR_URL . 'assets/images/posts-2-2-2-2-2-2-cols-circle.png',
				'3-3-3-3-cols-classic-grid'   => GRIMLOCK_PLUGIN_DIR_URL . 'assets/images/posts-3-3-3-3-cols-classic-grid.png',
	...
	public function render_block( $attributes, $content ) {
		...
		ob_start();
		do_action( 'grimlock_term_query', apply_filters( "{$this->id_base}_component_args", $this->get_component_args( $attributes ), $attributes ) );
		return ob_get_clean();
	}
	...
	protected function make_query( $attributes ) {
		...
		$args = apply_filters( "{$this->id_base}_query_args", $args );

		return new WP_Term_Query( $args );
	}
}

return new Grimlock_Term_Query_Block();
