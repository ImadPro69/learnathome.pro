				...
				<ul class="item-list-tabs-ul clearfix">
					...
					<?php if ( is_user_logged_in() ) : ?>
						...
						<?php if ( bp_is_active( 'friends' ) ) :
							$friends_url = wp_registration_url();
							if ( function_exists( 'bp_loggedin_user_url' ) ) {
								$friends_url = bp_loggedin_user_url( bp_members_get_path_chunks( array( bp_get_activity_slug(), bp_get_friends_slug() ) ) );
							}
							else {
								$friends_url = bp_loggedin_user_domain() . bp_get_activity_slug() . '/' . bp_get_friends_slug() . '/';
							} ?>
						...
						<?php if ( bp_is_active( 'groups' ) ) :
							$groups_url = wp_registration_url();
							if ( function_exists( 'bp_loggedin_user_url' ) ) {
								$groups_url = bp_loggedin_user_url( bp_members_get_path_chunks( array( bp_get_activity_slug(), bp_get_groups_slug() ) ) );
							}
							else {
								$groups_url = bp_loggedin_user_domain() . bp_get_activity_slug() . '/' . bp_get_groups_slug() . '/';
							} ?>
						...
						<?php if ( bp_get_total_favorite_count_for_user( bp_loggedin_user_id() ) ) :
							$favorites_url = wp_registration_url();
							if ( function_exists( 'bp_loggedin_user_url' ) ) {
								$favorites_url = bp_loggedin_user_url( bp_members_get_path_chunks( array( bp_get_activity_slug(), 'favorites' ) ) );
							}
							else {
								$favorites_url = bp_loggedin_user_domain() . bp_get_activity_slug() . '/favorites/';
							} ?>
						...
						<?php if ( bp_activity_do_mentions() ) :
							$mentions_url = wp_registration_url();
							if ( function_exists( 'bp_loggedin_user_url' ) ) {
								$mentions_url = bp_loggedin_user_url( bp_members_get_path_chunks( array( bp_get_activity_slug(), 'mentions' ) ) );
							}
							else {
								$mentions_url = bp_loggedin_user_domain() . bp_get_activity_slug() . '/mentions/';
							} ?>
