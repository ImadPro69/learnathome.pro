...
<form action="<?php echo trailingslashit( $filters_escaped->action ); ?>" method="<?php echo $filters_escaped->method; ?>" id="<?php echo $form_id; ?>" class="<?php echo $form_class; ?> bps_form bps-form-home">
