...
<div id="buddypress">
	...
	<div class="page" id="register-page">
		...
		<ul class="nav nav-pills nav-register mb-4 justify-content-center" role="tablist">
			<li class="nav-item mx-2 <?php if ( 'registration-disabled' === bp_get_current_signup_step() ) : ?>d-none<?php endif; ?>">
				<a class="btn btn-link <?php if ( 'registration-disabled' !== bp_get_current_signup_step() ) : ?>active<?php endif; ?>" id="pills-register-tab" data-toggle="pill" href="#pills-register" role="tab"><span class="d-block p-2"><?php esc_html_e( 'Register', 'buddypress' ); ?></span></a>
			</li>
			<li class="nav-item mx-2">
				<a class="btn btn-link <?php if ( 'registration-disabled' === bp_get_current_signup_step() ) : ?>active<?php endif; ?>" id="pills-login-tab" data-toggle="pill" href="#pills-login" role="tab"><span class="d-block p-2"><?php esc_html_e( 'Log In', 'buddypress' ); ?></span></a>
			</li>
		</ul>

		<div class="tab-content" id="pills-tabContent">

			<div class="tab-pane tab-pane--register fade <?php if ( 'registration-disabled' === bp_get_current_signup_step() ) : ?>d-none<?php else : ?>show active<?php endif; ?>" id="pills-register" role="tabpanel">
			...
			<div class="tab-pane tab-pane--login fade <?php if ( 'registration-disabled' === bp_get_current_signup_step() ) : ?>show active<?php endif; ?>" id="pills-login" role="tabpanel">
