									...
									<div class="row m-0">
										<?php if ( bp_is_active( 'notifications' ) ) : ?>
											...
											if ( function_exists( 'bp_displayed_user_url' ) ) {
												$notifications_url = bp_displayed_user_url( bp_members_get_path_chunks( array( bp_get_notifications_slug() ) ) );
											}
											else {
												$notifications_url = bp_get_displayed_user_link() . bp_get_notifications_slug();
											}
											?>
											<div class="col p-0">
												<a class="d-block px-3 py-2 text-center item--notifications" href="<?php echo esc_url( $notifications_url ); ?>" title="<?php esc_html_e( 'Notifications', 'buddypress' ); ?>">
										...
										<?php if ( bp_is_active( 'messages' ) ) : ?>
											...
											if ( function_exists( 'bp_displayed_user_url' ) ) {
												$messages_url = bp_displayed_user_url( bp_members_get_path_chunks( array( bp_get_messages_slug() ) ) );
											}
											else {
												$messages_url = bp_get_displayed_user_link() . bp_get_messages_slug();
											}
											?>
											<div class="col p-0">
												<a class="d-block px-3 py-2 text-center item--messages" href="<?php echo esc_url( $messages_url ); ?>" title="<?php esc_html_e( 'Messages', 'buddypress' ); ?>">
										...
										<?php if ( bp_is_active( 'settings' ) ) :
											if ( function_exists( 'bp_displayed_user_url' ) ) {
												$settings_url = bp_displayed_user_url( bp_members_get_path_chunks( array( bp_get_settings_slug() ) ) );
											}
											else {
												$settings_url = bp_get_displayed_user_link() . bp_get_settings_slug();
											} ?>
											<div class="col p-0">
												<a class="d-block px-3 py-2 text-center item--settings" href="<?php echo esc_url( $settings_url ); ?>" title="<?php esc_html_e( 'Settings', 'buddypress' ); ?>"></a>
											</div>
										<?php endif; ?>
									</div>
								</div>
