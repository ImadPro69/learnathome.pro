...
class Grimlock_BuddyPress_Navigation_Customizer {
	...
	public function add_stick_to_top_background_color_elements( $elements ) {
		return array_merge( $elements, array(
			'body:not(.grimlock--custom_header-displayed) .grimlock-navigation:not(.vertical-navbar)',
			'body:not(.grimlock--custom_header-displayed):not(.grimlock--navigation-unstick-to-top) .grimlock-navigation:not(.vertical-navbar)',
			'body.bp-user[class*="yz-"][class*="-scheme"]:not(.grimlock--custom_header-displayed) .grimlock-navigation:not(.vertical-navbar)',
			'body.bp-user[class*="yz-"][class*="-scheme"]:not(.grimlock--custom_header-displayed):not(.grimlock--navigation-unstick-to-top) .grimlock-navigation:not(.vertical-navbar)',
