...
class Grimlock_BuddyPress_Navbar_Nav_Menu_Component extends Grimlock_Component {
	...
	public function render() {
		if ( function_exists( 'buddypress' ) && $this->is_displayed() ) :
			...
			<ul class="nav navbar-nav navbar-nav--buddypress <?php echo is_user_logged_in() ? 'logged-in' : 'logged-out'; ?>">
				...
				if ( apply_filters( 'grimlock_buddypress_navbar_nav_menu_item_friends_displayed', true ) && bp_is_active( 'friends' ) && is_user_logged_in() ) :
					if ( function_exists( 'bp_loggedin_user_url' ) ) {
						$friends_url = bp_loggedin_user_url( bp_members_get_path_chunks( array( bp_get_friends_slug() ) ) );
					}
					else {
					...
					<li class="menu-item ml-0 menu-item--friends">
						...
						<?php endif; ?>
						<a href="<?php echo esc_url( $friends_url ); ?>" <?php if ( $tooltips_enabled ) : ?>data-toggle="tooltip" data-placement="bottom" title="<?php esc_attr_e( 'Friends', 'grimlock-buddypress' ); ?>"<?php endif; ?>>
							<span class="sr-only"><?php
								/* translators: %s: Friends slug */
								printf( esc_html__( 'My %s', 'grimlock-buddypress' ), esc_html( bp_get_friends_slug() ) ); ?></span>
						</a>
					</li>
				...
				if ( apply_filters( 'grimlock_buddypress_navbar_nav_menu_item_groups_displayed', true ) && bp_is_active( 'groups' ) && is_user_logged_in() ) :
					if ( function_exists( 'bp_loggedin_user_url' ) ) {
						$groups_url = bp_loggedin_user_url( bp_members_get_path_chunks( array( bp_get_groups_slug() ) ) );
					}
					else {
						$groups_url = bp_loggedin_user_domain() . bp_get_groups_slug();
					} ?>
					...
					<li class="menu-item ml-0 menu-item--groups">
						...
						<?php endif; ?>
						<a href="<?php echo esc_url( $groups_url ); ?>" <?php if ( $tooltips_enabled ) : ?>data-toggle="tooltip" data-placement="bottom" title="<?php esc_attr_e( 'Groups', 'grimlock-buddypress' ); ?>"<?php endif; ?>>
							<span class="sr-only"><?php
								/* translators: %s: Groups slug */
								printf( esc_html__( 'My %s', 'grimlock-buddypress' ), esc_html( bp_get_groups_slug() ) ); ?></span>
						</a>
					</li>
				...
				if ( apply_filters( 'grimlock_buddypress_navbar_nav_menu_item_notifications_displayed', true ) && bp_is_active( 'notifications' ) && is_user_logged_in() ) :
					if ( function_exists( 'bp_loggedin_user_url' ) ) {
						$notifications_url = bp_loggedin_user_url( bp_members_get_path_chunks( array( bp_get_notifications_slug() ) ) );
					}
					else {
					...
					<li class="menu-item ml-0 menu-item--notifications">
						...
						<?php endif; ?>
						<a href="<?php echo esc_url( $notifications_url ); ?>" <?php if ( $tooltips_enabled ) : ?>data-toggle="tooltip" data-placement="bottom" title="<?php esc_attr_e( 'Notifications', 'grimlock-buddypress' ); ?>"<?php endif; ?>>
							<span class="sr-only"><?php
								/* translators: %s: Notifications slug */
								printf( esc_html__( 'My %s', 'grimlock-buddypress' ), esc_html( bp_get_notifications_slug() ) ); ?></span>
						</a>
				...
				if ( apply_filters( 'grimlock_buddypress_navbar_nav_menu_item_messages_displayed', true ) && bp_is_active( 'messages' ) && is_user_logged_in() ) :
					if ( function_exists( 'bp_loggedin_user_url' ) ) {
						$messages_url = bp_loggedin_user_url( bp_members_get_path_chunks( array( bp_get_messages_slug() ) ) );
					}
					else {
					...
					<li class="menu-item ml-0 menu-item--messages">
						...
						<?php endif; ?>
						<a href="<?php echo esc_url( $messages_url ); ?>" <?php if ( $tooltips_enabled ) : ?>data-toggle="tooltip" data-placement="bottom" title="<?php esc_attr_e( 'Messages', 'grimlock-buddypress' ); ?>"<?php endif; ?>>
							<span class="sr-only"><?php
								/* translators: %s: Messages slug */
								printf( esc_html__( 'My %s', 'grimlock-buddypress' ), esc_html( bp_get_messages_slug() ) ); ?></span>
						</a>
					</li>
				...
				if ( apply_filters( 'grimlock_buddypress_navbar_nav_menu_item_settings_displayed', true ) && bp_is_active( 'settings' ) && is_user_logged_in() ) :
					if ( function_exists( 'bp_loggedin_user_url' ) ) {
						$settings_url = bp_loggedin_user_url( bp_members_get_path_chunks( array( bp_get_settings_slug() ) ) );
					}
					else {
					...
					<li class="menu-item ml-0 menu-item--settings">
						<a href="<?php echo esc_url( $settings_url ); ?>" <?php if ( $tooltips_enabled ) : ?>data-toggle="tooltip" data-placement="bottom" title="<?php esc_attr_e( 'Settings', 'grimlock-buddypress' ); ?>"<?php endif; ?>>
						</a>
					</li>
				...
				<?php if ( apply_filters( 'grimlock_buddypress_navbar_nav_menu_item_avatar_displayed', true ) ) : ?>
