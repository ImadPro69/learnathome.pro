...
<div class="tribe-events-meta-group tribe-events-meta-group-organizer p-0">
	...
	<div class="tribe-organizers">
		...
		<?php
		$organizers_query = new WP_Query( array(
		...
		if ( $organizers_query->have_posts() ) :
			while ( $organizers_query->have_posts() ) : $organizers_query->the_post(); ?>
						...
						<div class="tribe-organizer-img mb-2">
							...
							<?php endif; ?>
								...
								<?php if ( has_post_thumbnail() ) : ?>
									...
									echo get_the_post_thumbnail( get_the_ID(), array( 50, 50 ), $post_thumbnail_attrs ); ?>
								<?php else : ?>
